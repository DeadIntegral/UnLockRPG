var upgrade = {
	lock:{
		stat:{
			...
			3:{name:'Unlock Mana Point', costExp:500, target:'mp'},
		...
		statBtn:{
			...
			2:{name:'Unlock Up 100 Button - alt+click', costExp:2000},
			3:{name:'Unlock Up 1000 Button - ctrl+click', costExp:40000}
		},
		idle:{
			0:{name:'Unlock Generate +1 Exp/s', costExp:10, costGold:20, addExp:1},
			1:{name:'Unlock Generate +1 Gold/s', costGold:50, addGold:1, otherUnlock:'menu'},
